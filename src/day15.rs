...
fn parse() -> (Vec<isize>, usize, usize) {
    ...
    let mut number_timestamps = vec![-1; ITERATIONS_P2];
...
fn run_until(round: &mut usize, nb_timestamps: &mut [isize], last_nb: &mut usize, max_iter: usize) {
