fn run_prog(mut tab: Vec<usize>) -> usize {
...
// It's bruteforce but still REALLY fast
// (and no cheating, the program is doing everything all alone c:)
fn main() {
    ...
    for noun in 0..99 {
        ...
        for verb in 0..99 {
            tab[2] = verb;
            if run_prog(tab.clone()) == 19_690_720 {
                println!(
                    "Verb: {}\nNoun: {}\nResult: {}",
                    verb,
                    noun,
